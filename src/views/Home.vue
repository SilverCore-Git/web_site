...
<template>
    ...
    <main class="flex justify-center items-center flex-col" style="height: 80vh; width: 100%;">

        <h1 class=" text-8xl font-bold uppercase tracking-wider mb-18">silvercore</h1>
    ...
    <section class="flex justify-center items-center flex-col" style="height: 100vh; width: 100%;" id="services">
      ...
      <h1 class="text-6xl font-bold uppercase tracking-wider mb-28">Nos services</h1>
